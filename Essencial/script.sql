...
-- Inserção de dados iniciais na tabela 'marinas'
INSERT INTO `marinas` (`id`, `nome`, `endereco`, `contato`, `cnpj`, `dt_validade`) VALUES
(7, 'EMB / MTA NÃO GARAGIADAS', NULL, NULL, NULL, NULL);

-- Ajuste no valor de AUTO_INCREMENT das tabelas
ALTER TABLE `embarcacoes` AUTO_INCREMENT = 19;
ALTER TABLE `marinas` AUTO_INCREMENT = 15;
COMMIT;
